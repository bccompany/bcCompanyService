...
export const MONGODB_URI = process.env.MONGODB_URI || 'mongodb+srv://bccompany:faramPeAayein@420@rootcluster.ufit2.mongodb.net/BcCompany?retryWrites=true&w=majority';
